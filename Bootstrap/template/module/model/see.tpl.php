...
?>
<h1><?php $archive->model_type . ' ' . $archive->model_id . ' version ' . $archive->model_attributes_version; ?></h1>
<?php
...
?></ul>
<br/>
<a class="btn btn-danger" href="<?= $page_url( 'archive', $archive->model_id ) ?>'"><i class="icon-th-list"></i> List</a>
<a class="btn btn-danger" href="<?= $page_url( 'restore', $archive->model_id, $archive->model_attributes_version ) ?>'"><i class="icon-pencil"></i> Restore</a>
